...
class HighLevel(models.Model):
    ...
    user = models.OneToOneField(User, on_delete=models.CASCADE)
    name = models.CharField(max_length=20)
    isHighLvl = models.BooleanField(required=False)
...
class Comment(models.Model):
    ...
    def __str__(self):
        return self.engineer.name + ': ' + self.stageTitle + ': ' + self.author.name
...
class Stage(models.Model):
    ...
    def __str__(self):
        return self.engineer.name + ': ' + self.title
...
class StageLinkComment(models.Model):
    ...
    def __str__(self):
        return self.stage.engineer.name + ': ' + self.stage.title + ': ' + self.author.name